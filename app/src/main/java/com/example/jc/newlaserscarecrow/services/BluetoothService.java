...
import com.example.jc.newlaserscarecrow.application.BluetoothAction;
 ...
 *                  --BluetoothService--
 *
 * This service (like all services) runs in the background, and
 * handles all Bluetooth operations. This is responsible for
 *
 * -Connecting to a selected bluetooth device
 * -Disconnecting from a bluetooth device once its activity is left
 * -Reads and writes to and from connected bluetooth device
 */
